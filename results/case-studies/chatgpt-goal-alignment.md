...
- **MIT Sloan Management Review (2023):** Knowledge worker AI usage patterns
  ...
  URL: https://sloanreview.mit.edu/article/how-generative-ai-will-transform-knowledge-work/
- **Stanford VPTL (2023):** Student AI usage patterns
  (essay help 58%, concept explanation 42%, problem solving 31%)
  URL: https://vptl.stanford.edu/resources/ai-tools
- **Pew Research Center (2023):** Demographic breakdown and casual usage patterns
  URL: https://www.pewresearch.org/internet/2023/11/21/how-americans-use-chatgpt/
- **Bastani et al. (2023), NBER Working Paper:** AI tutoring impact on learning outcomes;
  ...
  URL: https://www.nber.org/papers/w31753
- **OpenAI (2023):** 100 million weekly active users milestone announcement
...
- Bastani, H., Bastani, O., Sungu, A., Ge, H., Kabakcı, Ö., & Mariman, R. (2023).
  *Generative AI Can Harm Learning*. NBER Working Paper.
  https://www.nber.org/papers/w31753
- Pew Research Center. (2023). *Americans' Use of ChatGPT Is Limited, but Those
  Who Have Used It Find It Useful*.
  https://www.pewresearch.org/internet/2023/11/21/how-americans-use-chatgpt/
- MIT Sloan Management Review. (2023). *How Generative AI Will Transform Knowledge Work*.
  https://sloanreview.mit.edu/article/how-generative-ai-will-transform-knowledge-work/
- Stanford Human-Centered AI. (2023). *AI Index Report 2023*.
  https://hai.stanford.edu/research/ai-index-report
- Stanford VPTL. (2023). *AI Tools at Stanford: Resources and Guidance*.
  https://vptl.stanford.edu/resources/ai-tools
